...
data_path = '../data/mask_cut/water_mask/'
...
def read_mask(image_id):
    ...
    mask = misc.imread("../data/mask_cut/water_mask/{}".format(image_id))
...
def cache_train_3():
    ...
    f = h5py.File(os.path.join('../data/', 'chen_train_water5.h5'), 'w', compression='blosc:lz4', compression_opts=9)
