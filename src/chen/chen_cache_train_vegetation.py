...
def read_mask(image_id):
    ...
    mask = misc.imread("../data/mask_vegetation/{}.png".format(image_id))
...
def cache_train_3():
    ...
    f = h5py.File(os.path.join(data_path, 'chen_train_vegetation.h5'), 'w', compression='blosc:lz4', compression_opts=9)
