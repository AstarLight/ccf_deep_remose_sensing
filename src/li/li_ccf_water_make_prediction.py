...
def read_model(cross=''):
    json_name = 'architecture_128_25_chen_water_v1' + cross + '.json'
    weight_name = 'model_weights_128_25_chen_water_v1' + cross + '.h5'
...
for image_id in tqdm(test_ids):
    ...
    misc.imsave("../data/all/new/BDCI2017-jiage/CCF-testing/{}_water_predict.png".format(image_id), mask_1)
